...
function onScriptUpdate()
	...
	if core.getVehicle() == "Sneakster" or core.getVehicle() == "Spear" or core.getVehicle() == "Phantom" or core.getVehicle() == "Jet Bubble" or core.getVehicle() == "Wario Bike" then
		if core.getFrameOfInput() <= 18 then SetMainStickX(205) SetMainStickY(128)
		elseif core.getFrameOfInput() == 19 then SetMainStickX(59) SetMainStickY(128) PressButton("D-Up")
		elseif core.getFrameOfInput() <= 22 then SetMainStickX(59) SetMainStickY(128)
		elseif core.getFrameOfInput() == 23 then SetMainStickX(128) SetMainStickY(128)
		elseif core.getFrameOfInput() <= 26 then SetMainStickX(59) SetMainStickY(112)
		elseif core.getFrameOfInput() <= 39 then SetMainStickX(59) SetMainStickY(128)
		elseif core.getFrameOfInput() <= 43 then SetMainStickX(128) SetMainStickY(128)
		elseif core.getFrameOfInput() <= 49 then SetMainStickX(59) SetMainStickY(128)
		elseif core.getFrameOfInput() == 50 then SetMainStickX(59) SetMainStickY(205)
		elseif core.getFrameOfInput() <= 52 then SetMainStickX(128) SetMainStickY(205)
		elseif core.getFrameOfInput() == 53 then SetMainStickX(59) SetMainStickY(205)
		elseif core.getFrameOfInput() <= 60 then SetMainStickX(128) SetMainStickY(205)
		elseif core.getFrameOfInput() <= 76 then SetMainStickX(205) SetMainStickY(205)
		elseif core.getFrameOfInput() == 77 then SetMainStickX(59) SetMainStickY(128) PressButton("D-Up")
		elseif core.getFrameOfInput() <= 96 then SetMainStickX(59) SetMainStickY(128)
		elseif core.getFrameOfInput() <= 116 then SetMainStickX(205) SetMainStickY(128) PressButton("D-Up")
		elseif core.getFrameOfInput() == 117 then SetMainStickX(128) SetMainStickY(128)
		elseif core.getFrameOfInput() <= 127 then SetMainStickX(59) SetMainStickY(205)
		elseif core.getFrameOfInput() <= 129 then SetMainStickX(59) SetMainStickY(128)
		...
		elseif core.getFrameOfInput() == 142 then SetMainStickX(68) SetMainStickY(128) PressButton("A")
		elseif core.getFrameOfInput() <= 147 then SetMainStickX(59) SetMainStickY(128) PressButton("A")
		...
		elseif core.getFrameOfInput() <= 222 then SetMainStickX(59) SetMainStickY(128) PressButton("A")
