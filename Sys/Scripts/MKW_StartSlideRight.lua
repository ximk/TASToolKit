...
function onScriptUpdate()
	...
	if core.getVehicle() == "Sneakster" or core.getVehicle() == "Spear" or core.getVehicle() == "Phantom" or core.getVehicle() == "Jet Bubble" or core.getVehicle() == "Wario Bike"  then -- last 2 are guesses
		if core.getFrameOfInput() <= 19 then SetMainStickX(59) SetMainStickY(128)
		elseif core.getFrameOfInput() == 20 then SetMainStickX(205) SetMainStickY(128) PressButton("D-Up")
		elseif core.getFrameOfInput() <= 23 then SetMainStickX(205) SetMainStickY(128)
		elseif core.getFrameOfInput() == 24 then SetMainStickX(128) SetMainStickY(128)
		elseif core.getFrameOfInput() <= 27 then SetMainStickX(205) SetMainStickY(112)
		elseif core.getFrameOfInput() <= 40 then SetMainStickX(205) SetMainStickY(128)
		elseif core.getFrameOfInput() <= 44 then SetMainStickX(128) SetMainStickY(128)
		elseif core.getFrameOfInput() <= 50 then SetMainStickX(205) SetMainStickY(128)
		elseif core.getFrameOfInput() == 51 then SetMainStickX(205) SetMainStickY(205)
		elseif core.getFrameOfInput() <= 53 then SetMainStickX(128) SetMainStickY(205)
		elseif core.getFrameOfInput() == 54 then SetMainStickX(205) SetMainStickY(205)
		elseif core.getFrameOfInput() <= 61 then SetMainStickX(128) SetMainStickY(205)
		elseif core.getFrameOfInput() <= 77 then SetMainStickX(59) SetMainStickY(205)
		elseif core.getFrameOfInput() == 78 then SetMainStickX(205) SetMainStickY(128) PressButton("D-Up")
		elseif core.getFrameOfInput() <= 97 then SetMainStickX(205) SetMainStickY(128)
		elseif core.getFrameOfInput() <= 117 then SetMainStickX(59) SetMainStickY(128) PressButton("D-Up")
		elseif core.getFrameOfInput() == 118 then SetMainStickX(128) SetMainStickY(128)
		elseif core.getFrameOfInput() <= 128 then SetMainStickX(205) SetMainStickY(205)
		...
		elseif core.getFrameOfInput() <= 135 then SetMainStickX(205) SetMainStickY(128)
		...
		elseif core.getFrameOfInput() == 143 then SetMainStickX(197) SetMainStickY(128) PressButton("A")
		elseif core.getFrameOfInput() <= 148 then SetMainStickX(205) SetMainStickY(128) PressButton("A")
		elseif core.getFrameOfInput() <= 164 then SetMainStickX(59) SetMainStickY(205) PressButton("A")
		elseif core.getFrameOfInput() == 165 then SetMainStickX(59) SetMainStickY(128) PressButton("D-Up") PressButton("A")
		...
		elseif core.getFrameOfInput() <= 208 then SetMainStickX(59) SetMainStickY(128) PressButton("A")
		elseif core.getFrameOfInput() <= 214 then SetMainStickX(205) SetMainStickY(205) PressButton("A")
		elseif core.getFrameOfInput() <= 223 then SetMainStickX(205) SetMainStickY(128) PressButton("A")
