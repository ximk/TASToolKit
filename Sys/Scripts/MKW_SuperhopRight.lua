...
function onScriptUpdate()
	...
	if core.getFrameOfInput() == startFrame then PressButton("A") PressButton("R") SetMainStickX(59)
	elseif core.getFrameOfInput() == startFrame + 1 then PressButton("A") PressButton("R") SetMainStickX(152)
	elseif core.getFrameOfInput() == startFrame + 2 then PressButton("A") PressButton("R") SetMainStickX(59)
	elseif airtime ~= 0 then PressButton("A") PressButton("R") SetMainStickX(59)
